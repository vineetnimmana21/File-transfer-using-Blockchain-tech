	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
			...
			<nav id="colorlib-main-menu" role="navigation" class="navbar">
				<div class="collapse">
					<ul>
			  <li class="active"><a href="Cloud_Home.jsp" data-nav-section="home">Home</a></li>
						...
						<li><a href="View_All_User.jsp" data-nav-section="services">View Data Users</a></li>
                                                <li><a href="Activate_File.jsp" data-nav-section="services">Activate File</a></li>
						...
						<li><a href="View_request.jsp" data-nav-section="experience">Send Decryption Key to User</a></li>
                                                ...
                                                <li><a href="Attack_Files.jsp" data-nav-section="about">Attack_Files</a></li>
							...
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
                                                                                 <center>   <h2 style="color:black"> Blockchain-based Decentralized Authentication Modeling Scheme in Edge and IoT Environment </h2> </center>
                                                                                <h2 class="colorlib-heading" style="color:darkcyan;">Activate File</h2>
                                                                             <style>
                                                                            table{
                                                                            color:black;
                                                                            width: 80%;
                                                                        ...
                                                                        <table>
                                                                            <tr>
                                                                                ...
                                                                                <th>Secret Key</th>
                                                                                <th>File Key</th>
                                                                                <th>Activate Files</th>
                                                                            </tr>
                                                                            <%
                                                                                    Connection con=new DB().fun();
                                                                                    PreparedStatement p=con.prepareStatement("select * from upload where coowner='not-accept' ");
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><a href="Activate.jsp?id=<%=r.getString("id")%>&&oname=<%=r.getString("oname")%>&&fname=<%=r.getString("fname")%>" style="color:green;">Click Here</a></td>
