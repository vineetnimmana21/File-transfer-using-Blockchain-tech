	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
			...
			<nav id="colorlib-main-menu" role="navigation" class="navbar">
				<div  class="collapse">
					<ul>
			                      <li><a href="n1home.jsp" data-nav-section="home">Home</a></li>
                                               <li><a href="nn1.jsp" data-nav-section="home">View Files</a></li>
...
.column {
  ...
  padding: 5px;
                                                                        ...
                                                                        <div class="row">
  <div class="column">
      <a href="n1n.jsp"><img src="images/no.jpg" style="width:100px; height:100px;" >
      <p style=" font-weight:bolder;">Node 1</p></a>
  
  </div>
  <div class="column">
      <a href="n2n.jsp"><img src="images/no.jpg"  style="width:100px; height:100px;">
       <p style="  font-weight:bolder;">Node 2</p></a>
  
  </div> 
                                                                            
    <div class="column">
      <a href="n3n.jsp"><img src="images/no.jpg"  style="width:100px; height:100px;">
       <p style="  font-weight:bolder;">Node 3</p></a>
  
  </div> 
                                                                            
   <div class="column">
      <a href="n4n.jsp"><img src="images/no.jpg"  style="width:100px; height:100px;">
       <p style="  font-weight:bolder;">Node 4</p></a>
  
  </div> 
              
                                                                             <div class="column">
      <a href="n5n.jsp"><img src="images/no.jpg"  style="width:100px; height:100px;">
