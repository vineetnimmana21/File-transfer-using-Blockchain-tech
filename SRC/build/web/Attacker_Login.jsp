			...
			<nav id="colorlib-main-menu" role="navigation" class="navbar">
				<div class="collapse">
					<ul>
						...
						<li><a href="Data co-Owner.jsp" data-nav-section="services">Admin</a></li>
						
						<li><a href="Data_Accessor.jsp" data-nav-section="blog">Group User</a></li>
						<li ><a href="TA_Login.jsp" data-nav-section="education">Trust Attributor</a></li>
						<li><a href="Cloud_Login.jsp" data-nav-section="experience">Cloud Server</a></li>
						<li class="active"><a href="Attacker_Login.jsp" data-nav-section="work">Attacker</a></li>
					</ul>
				</div>
			</nav>
							...
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
                                                                                ...
                                                                                <h2 class="colorlib-heading" style="color:darkcyan;">Abstract</h2>
                                                                        ...
                                                                        <h2 style="margin-top: 70px; margin-left: 33%;color:MediumVioletRed;font-size: 25px;"><strong>Attacker Login</strong></h2>
