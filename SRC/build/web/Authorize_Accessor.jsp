							...
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
                                                                            <h2 class="colorlib-heading" style="color:mediumvioletred;"><b><center>Authorize Data Accessor Request</center></b></h2>
                                                                             <style>
                                                                            table{
                                                                            color:black;
                                                                            width: 80%;
                                                                        ...
                                                                        <table>
                                                                            ...
                                                                            <%
                                                                                    ...
                                                                                    PreparedStatement p=con.prepareStatement("select * from accessor_register where status='waiting' ");
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><a href="Owner_Action.jsp?ref=user&&id=<%=r.getString("id")%>&&oname=<%=r.getString("username")%>" style="color:green;">Authorize</a></td>
                                                                            </tr>
                                                                            <%}%>
