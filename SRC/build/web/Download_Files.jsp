							...
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
                                                                            <h2 class="colorlib-heading" style="color:MediumVioletRed;"><center>Download Files</center></h2>
                                                                             <style>
                                                                            table{
                                                                            color:black;
                                                                            width: 80%;
                                                                         ...
                                                                         <center><table>
                                                                            ...
                                                                            <%
                                                                                    ...
                                                                                    PreparedStatement p=con.prepareStatement("select * from request1 where  username='"+username+"' ");
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><a href="Download.jsp?username=<%=r.getString("username")%>&&fname=<%=r.getString("fname")%>&&fkey=<%=r.getString("fkey")%>" style="color:green;">Download</a></td>
