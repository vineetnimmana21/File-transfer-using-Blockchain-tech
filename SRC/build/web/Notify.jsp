							...
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
                                                                                ...
                                                                                <h2 class="colorlib-heading" style="color:darkcyan;">Send Notification for Attacked Files</h2>
                                                                             <style>
                                                                            table{
                                                                            color:black;
                                                                            width: 80%;
                                                                        ...
                                                                        <table>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><a href="Send_Notification.jsp?id=<%=r.getString("id")%>&&oname=<%=r.getString("oname")%>&&fname=<%=r.getString("fname")%>" style="color:green;">Click Here</a></td>
