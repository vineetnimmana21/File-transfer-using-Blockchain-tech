...
<html>
	...
	<title>Blockchain-based Decentralized Authentication
              Modeling Scheme in Edge and IoT Environment</title>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
			<div class="text-center">
				<div class="author-img" style="background-image: url(images/cloudphot.jpg);"></div>
		...
		<div id="colorlib-main">
			...
			<div class="about-desc">
                            ...
                            <h2 style="margin-top: 70px; margin-left: 33%;color:MediumVioletRed;font-size: 25px;"><strong>Data User Registration</strong></h2>
                            <form action="Accessor_Register_Action" method="post" enctype="multipart/form-data">
                            <table>
                            ...
                            <h4><a href="Data_Accessor.jsp" style="color:mediumvioletred;margin-left: 38%;">If Already Account?</a>Login</h4>
                            </div>
			</div>
			</div>
			</div>
