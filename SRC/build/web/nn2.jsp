	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
			...
			<nav id="colorlib-main-menu" role="navigation" class="navbar">
				<div  class="collapse">
					<ul>
			                      <li><a href="n2home.jsp" data-nav-section="home">Home</a></li>
                                               <li><a href="nn2.jsp" data-nav-section="home">View Files</a></li>
...
.column {
  ...
  padding: 5px;
                                                                        ...
                                                                        <div class="row">
  <div class="column">
      <a href="n21n.jsp"><img src="images/no.jpg" style="width:100px; height:100px;" >
      <p style=" font-weight:bolder;">Node 1</p></a>
  
  </div>
  <div class="column">
      <a href="n22n.jsp"><img src="images/no.jpg"  style="width:100px; height:100px;">
       <p style="  font-weight:bolder;">Node 2</p></a>
  
  </div> 
                                                                            
    <div class="column">
      <a href="n23n.jsp"><img src="images/no.jpg"  style="width:100px; height:100px;">
       <p style="  font-weight:bolder;">Node 3</p></a>
  
  </div> 
                                                                            
   <div class="column">
      <a href="n24n.jsp"><img src="images/no.jpg"  style="width:100px; height:100px;">
       <p style="  font-weight:bolder;">Node 4</p></a>
  
  </div> 
              
                                                                             <div class="column">
      <a href="n25n.jsp"><img src="images/no.jpg"  style="width:100px; height:100px;">
