				...
				<div  class="collapse">
					<ul>
			                      <li><a href="n1home.jsp" data-nav-section="home">Home</a></li>
                                               <li><a href="n1n.jsp" data-nav-section="home">View Files</a></li>
									...
									<div class="about-desc">
                                                                        ...
                                                                        <table>
                                                                            ...
                                                                            <%
                                                                                    ...
                                                                                    PreparedStatement p=con.prepareStatement("select * from upload  where network='net2' and node='n5' ");
                                                                            ...
                                                                            <br>
                                                                            <a href="nn2.jsp">Click back to Network</a>
                                                                         </center>
                                                                    </div>
								</div>
							</div>
