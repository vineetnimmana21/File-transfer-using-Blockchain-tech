							...
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
                                                                        ...
                                                                        <h2 style="margin-top: 70px; margin-left: 33%;color:MediumVioletRed;font-size: 25px;"><strong>Data Owner Login</strong></h2>
                                                                        ...
                                                                        <table>
                                                                            ...
                                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                            <br> <tr><td align="center" colspan="2" ><input type="submit" value="Login" style=" width:100px;"></td></tr>
                                                                        </table></form><br>
                                                                     
                                                                        <h4><a href="Owner_Register.jsp" style="color:mediumvioletred;margin-left: 38%;">If New Owner?</a>Register</h4>
                                                                        </div>
								</div>
							</div>
						</div>
