...
<html>
	...
	<title>Achieving Secure and Dynamic Range Queries Over Encrypted Cloud Data</title>
							...
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
                                                                             <h2 class="colorlib-heading" style="color:mediumvioletred;"><b><center>Send Encryption & secret key to cloud </center></b></h2>
                                                                             <style>
                                                                            table{
                                                                            color:black;
                                                                            width: 80%;
                                                                         ...
                                                                         <center><table>
                                                                            <tr>
                                                                                ...
                                                                                <th>Secret Key Status</th>
                                                                                <th>Action</th>
                                                                            </tr>
                                                                            <%
                                                                                    Connection con=new DB().fun();
                                                                                    PreparedStatement p=con.prepareStatement("select * from owner_register where username='"+uname+"' ");
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><%=r.getString("estatus")%></td>
                                                                                <td><%=r.getString("sstatus")%></td>
                                                                                <td><a href="Key_Request.jsp?id=<%=r.getString("id")%>&&oname=<%=r.getString("username")%>" style="color:green;">Send Request</a></td>
                                                                            </tr>
                                                                            <%}%>
