...
<html>
	...
	<title>Blockchain-based Decentralized Authentication Modeling Scheme in Edge and IoT Environments</title>
							...
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
                                                                            <center>
                                                                                     <h2 class="colorlib-heading" style="color:mediumvioletred;"><b><center>Authorize Data Owner Request</center></b></h2>
                                                                             <style>
                                                                            table{
                                                                            color:black;
                                                                            width: 80%;
                                                                        ...
                                                                        <table>
                                                                            ...
                                                                            <%
                                                                                    ...
                                                                                    PreparedStatement p=con.prepareStatement("select * from owner_register where status='waiting' ");
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><img src='dataset/<%=r.getString("pic")%>' alt="" style='width:50px;height: 30px;'></td>
                                                                                <td><a href="Owner_Action.jsp?ref=owner&&id=<%=r.getString("id")%>&&oname=<%=r.getString("username")%>" style="color:green;">Authorize</a></td>
                                                                            </tr>
                                                                            <%}%>
