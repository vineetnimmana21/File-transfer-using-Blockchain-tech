									...
									<div class="about-desc">
                                                                        ...
                                                                        <table>
                                                                            ...
                                                                            <%
                                                                                    ...
                                                                                    PreparedStatement p=con.prepareStatement("select * from upload where oname='"+uname+"' and network='net2' and node='n2' ");
                                                                            ...
                                                                            <%}%>
                                                                              ...
                                                                              <br>
                                                                            <a href="viewfiles1.jsp">Click back to Network</a>
