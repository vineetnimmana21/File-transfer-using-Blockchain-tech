							...
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
                                                                            <h2 class="colorlib-heading" style="color:mediumvioletred;"><b><center>File based On Networks</center></b></h2>
                                                                             <style>
                                                                            table{
                                                                            color:black;
                                                                            width: 80%;
...
.column {
  ...
  padding: 5px;
                                      ...
                                      Connection con=new DB().fun();
                                       PreparedStatement p=con.prepareStatement("select * from upload where oname='"+uname+"' ");
                                        ResultSet r=p.executeQuery();
                                          if(r.next()){
                                          String network=r.getString("network");
                                          String node=r.getString("node");
      ...
      <div class="row">
  <div class="column">
      <a href="net1.jsp"><img src="images/network.png" style="width:100px; height:100px;" >
      <p style=" font-weight:bolder;">Network 1</p></a>
  
  </div>
  <div class="column">
      <a href="net2.jsp"><img src="images/network.png"  style="width:100px; height:100px;">
       <p style="  font-weight:bolder;">Network 2</p></a>
