							...
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
                                                                                 <center>   <h2 style="color:darkblue"><b>Blockchain-based Decentralized Authentication
              Modeling Scheme in Edge and IoT Environment</b></h2> 
                                                                                 <h2 class="colorlib-heading" style="color:mediumvioletred;"><center><b>View All Files</b></center></h2>
                                                                             <style>
                                                                            table{
                                                                            color:black;
                                                                            width: 80%;
                                                                        ...
                                                                        <table>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><%=r.getString("network")%></td>
                                                                                <td><%=r.getString("node")%></td>
                                                                                </tr>
                                                                            <%}%>
