			...
			<nav id="colorlib-main-menu" role="navigation" class="navbar">
				<div  class="collapse">
					<ul>
						...
						<li ><a href="View_Uploaded_Files.jsp" data-nav-section="skills">View All Files</a></li>
						<li  class="active"><a href="Auditing_Request.jsp" data-nav-section="blog">Auditing the Files</a></li>
							...
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
                                                                                ...
                                                                                <h2 class="colorlib-heading" style="color:darkcyan;">Auditing Files</h2>
                                                                             <style>
                                                                            table{
                                                                            color:black;
                                                                            width: 80%;
                                                                        ...
                                                                        <table>
                                                                            ...
                                                                            <%
                                                                                    ...
                                                                                    PreparedStatement p=con.prepareStatement("select * from upload where oname='"+uname+"' ");
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><a href="Audit_Request.jsp?id=<%=r.getString("id")%>&&oname=<%=r.getString("oname")%>&&fname=<%=r.getString("fname")%>" style="color:green;">Send Request</a></td>
