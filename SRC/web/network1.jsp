							...
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
                                                                             <center>   <h2 style="color:darkblue"> Blockchain-based Decentralized Authentication Modeling Scheme in Edge and IoT Environment</h2> </center>
                                                                        ...
                                                                        <h2 style="margin-top: 70px; margin-left: 33%;color:MediumVioletRed;font-size: 25px;"><strong>Welcome Network 1(Block1)</strong></h2>
