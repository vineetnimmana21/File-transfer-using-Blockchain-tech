	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
			<div class="text-center">
				...
				<h1 id="colorlib-logo"><a href="index.jsp">Admin Home</a></h1>
				</div>
			<nav id="colorlib-main-menu" role="navigation" class="navbar">
				<div  class="collapse">
					<ul>
						<li class="active"><a href="Co_Owner_Home.jsp" data-nav-section="home">Home</a></li>
						<li><a href="Activate_File.jsp" data-nav-section="experience">File Activate</a></li>
				   			...
				   			<div class="row">
					   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
					   				<div class="slider-text-inner js-fullheight">
					   					<div class="desc">
                                                                                   <h1 style="color:white;">Blockchain-based Decentralized Authentication Modeling Scheme in Edge and IoT Environment</h1>
						   				</div>
					   				</div>
					   			</div>
					   		</div>
