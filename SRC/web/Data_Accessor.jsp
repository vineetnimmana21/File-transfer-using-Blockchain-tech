							...
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
                                                                        ...
                                                                        <h2 style="margin-top: 70px; margin-left: 38%;color:MediumVioletRed;font-size: 25px;"><strong>Data User Login</strong></h2>
                                                                        <form action="Accessor_Login">
                                                                        <table>
                                                                        ...
                                                                        <h4><a href="Accessor_Register.jsp" style="color:mediumvioletred;margin-left: 38%;">If New User?</a>Register</h4>
                                                                        </div>
								</div>
							</div>
						</div>
