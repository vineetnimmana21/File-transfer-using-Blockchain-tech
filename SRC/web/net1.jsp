...
.column {
  ...
  padding: 5px;
                                                                        ...
                                                                        <div class="row">
  <div class="column">
      <a href="n1.jsp"><img src="images/no.jpg" style="width:100px; height:100px;" >
      <p style=" font-weight:bolder;">Node 1</p></a>
  
  </div>
  <div class="column">
      <a href="n2.jsp"><img src="images/no.jpg"  style="width:100px; height:100px;">
       <p style="  font-weight:bolder;">Node 2</p></a>
  
  </div> 
                                                                            
    <div class="column">
      <a href="n3.jsp"><img src="images/no.jpg"  style="width:100px; height:100px;">
       <p style="  font-weight:bolder;">Node 3</p></a>
  
  </div> 
                                                                            
   <div class="column">
      <a href="n4.jsp"><img src="images/no.jpg"  style="width:100px; height:100px;">
       <p style="  font-weight:bolder;">Node 4</p></a>
  
  </div> 
              
                                                                             <div class="column">
      <a href="n5.jsp"><img src="images/no.jpg"  style="width:100px; height:100px;">
