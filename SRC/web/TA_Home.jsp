	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
			<div class="text-center">
				<div class="author-img" style="background-image: url(images/tpa.jpg);"></div>
				<h1 id="colorlib-logo"><a href="index.jsp">Trust Authority</a></h1>
				</div>
			<nav id="colorlib-main-menu" role="navigation" class="navbar">
				<div  class="collapse">
					<ul>
						<li class="active"><a href="TA_Home.jsp" data-nav-section="home">Home</a></li>
						<li><a href="Notify.jsp" data-nav-section="about">Send Notification</a></li>
						<li><a href="Generate_Owner_Key.jsp" data-nav-section="education">Generate Public & Secret Keys for Owners</a></li>
						<li><a href="View_request.jsp" data-nav-section="experience">Send Decryption Key to Accessor</a></li>
		...
		<div id="colorlib-main">
			<section id="colorlib-hero" class="js-fullheight" data-section="home">
				<div class="flexslider js-fullheight">
					<ul class="slides">
				   	<li style="background-image: url(images/CloudStorage.jpg);">
				   			...
				   			<div class="row">
					   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
					   				<div class="slider-text-inner js-fullheight">
					   					<div class="desc">
                                                                                  <h1 style="color:white"> A Data Sharing Protocol to Minimize Security and Privacy Risks of Cloud Storage in Big Data Era </h1> 
						   				</div>
					   				</div>
					   			</div>
					   		</div>
							...
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
										...
										<p> <strong>
                                                                                    A cloud-based big data sharing system utilizes a storage facility from a cloud service provider
...
security and privacy risks of sharing data in cloud storage and saves about 12% of storage space.</strong></p>
									</div>
								</div>
							</div>
						</div>
