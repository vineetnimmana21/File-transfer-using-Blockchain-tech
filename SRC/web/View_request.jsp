							...
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
                                                                                    <h2 class="colorlib-heading" style="color:mediumvioletred;"><center><b>Send Decrypt Key to Data Accessors</b></center></h2>
                                                                             <style>
                                                                            table{
                                                                            color:black;
                                                                            width: 80%;
                                                                        ...
                                                                        <table>
                                                                            ...
                                                                            <%
                                                                                    ...
                                                                                    PreparedStatement p=con.prepareStatement("select * from request1  ");
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><a href="Decrypt_Action.jsp?sno=<%=r.getString("sno")%>&&username=<%=r.getString("username")%>&&fname=<%=r.getString("fname")%>&&fkey=<%=r.getString("fkey")%>" style="color:green;"><%=status%></a></td>
                                                                            </tr>
                                                                            <%}%>
